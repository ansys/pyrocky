...
class RAMeshColoring(ApiElementItem):
    ...
    def SetNodeGridFunction(self, value: Union['SemanticAssociation', str, None]) -> None: ...
    ...
    def SetEdgeGridFunction(self, value: Union['SemanticAssociation', str, None]) -> None: ...
    ...
    def SetFaceGridFunction(self, value: Union['SemanticAssociation', str, None]) -> None: ...
    ...
    def SetVectorGridFunction(self, value: Union['SemanticAssociation', str, None]) -> None: ...
