...
class RAParticle(RAGridProcessElementItem, ElementWithAddins, _RAOrientationMixin):
    ...
    def SetInternalFriction(self, value: Union[str, float]) -> None: ...
    def GetPlasticLimit(self, unit: Optional[str] = ...) -> float: ...
    def SetPlasticLimit(self, value: Union[str, float], unit: Optional[str] = ...) -> None: ...
