...
class RAWall(RABaseGeometry, ElementWithAddins):
    ...
    def LoadFile(self, file_path: str, import_scale: float = ..., convert_yz: bool = ...) -> None: ...
    ...
    def SetHorizontalOffset(self, value: Union[str, float], unit: Union[str, None] = ...) -> None: ...
    def GetVerticalOffset(self, unit: Union[str, None] = ...) -> float: ...
    def SetVerticalOffset(self, value: Union[str, float], unit: Union[str, None] = ...) -> None: ...
    def GetOutOfPlaneOffset(self, unit: Union[str, None] = ...) -> float: ...
    def SetOutOfPlaneOffset(self, value: Union[str, float], unit: Union[str, None] = ...) -> None: ...
    ...
    def SetBoundaryMass(self, value: Union[str, float], unit: Optional[str] = ...) -> None: ...
    def GetGravityCenter(self, unit: Optional[str] = ...) -> List[float]: ...
    def SetGravityCenter(self, values: Sequence[Union[str, float]], unit: Optional[str] = ...) -> None: ...
    ...
    def SetReplicateTime(self, value: Union[str, float], unit: Optional[str] = ...) -> None: ...
    ...
    def SetVolumeShearWorkRatio(self, value: Union[str, float], unit: Optional[str] = ...) -> None: ...
